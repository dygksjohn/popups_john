          ...
          {loadingEvents ? (
            ...
            <div style={{ display: "flex", gap: 8, marginBottom: 16 }}>
              {[{id:"all",label:"전체"},{id:"active",label:"운영 중"},{id:"ended",label:"종료"},{id:"pending",label:"대기"}].map(t => {
                ...
                return (
                  <button key={t.id} onClick={() => setEventFilter(t.id)} style={{ padding: "8px 18px", cursor: "pointer", borderRadius: 22, fontSize: 13, fontWeight: 700, color: on ? "#fff" : ds.ink3, background: on ? ds.brand : ds.card, transition: "all .15s", display: "flex", alignItems: "center", gap: 6, fontFamily: ds.ff, border: `1px solid ${on ? ds.brand : ds.line}` }}>
                    {t.label}
